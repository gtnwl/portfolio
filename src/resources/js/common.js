...
//     boxWrap[i].addEventListener("mouseover", function () {
//       this.classList.add("hover");
//     });
//     boxWrap[i].addEventListener("mouseout", function (e) {
...
//   //요일은 숫자형태로 리턴 되기 때문에 미리 배열로 담아둠
//   var week = [
//     "Sunday",
//     "Monday",
//     "Tuesday",
...
//       var fileName = window.FileReader
//         ? $(this)[0].files[0].name
...
//           window.location.href("./AH/DSC-AH-003-02.html");
//         }
...
//         $toastBox = $(
//           '<article class="layerPopup_p04" id="toastBox" role="dialog">'
//         );
...
//       else if (option.comfirmBtn == "move")
//         $btnConfirm.attr("title", "바로가기");
//       else if (option.comfirmBtn != "")
//         $btnConfirm.attr("title", option.comfirmBtn);
...
//     $(function () {
//       $(document)
//         .on("focus", ".tabUiArea dt a", function (e) {
//           var obj = $(this),
